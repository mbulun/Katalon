...
WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/td_Dropbox Basic Flow  v5'))
...
WebUI.verifyElementPresent(findTestObject('Page_OneTeg  Simplified Integration/Dropbox Flow - Process completed'), 0)
