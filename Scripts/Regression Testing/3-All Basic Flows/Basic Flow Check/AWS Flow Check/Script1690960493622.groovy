...
WebUI.setText(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/input_Active_search-input'), 'aws')

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/div_AWS Basic Flow  v9'))
...
WebUI.verifyElementPresent(findTestObject('Page_OneTeg  Simplified Integration/AWS Flow - Process completed'), 0)
