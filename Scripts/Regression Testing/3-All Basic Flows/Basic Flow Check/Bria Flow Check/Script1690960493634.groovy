...
WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/td_Bria Basic Flow  v2'))

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/div_Search for images matching the given te_2d5cd4'))

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/button_Search Assets_flow-simulate'))

WebUI.verifyElementPresent(findTestObject('Page_OneTeg  Simplified Integration/Bria Flow - Process completed'), 0)
