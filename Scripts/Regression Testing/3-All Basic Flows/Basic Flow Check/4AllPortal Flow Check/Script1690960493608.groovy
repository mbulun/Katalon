...
WebUI.setText(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/input_Active_search-input'), '4Allportal')

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/div_4Allportal Hospital Basic Flow  v9'))
...
WebUI.verifyElementPresent(findTestObject('Page_OneTeg  Simplified Integration/4Allportal Flow - Process completed'), 0)
