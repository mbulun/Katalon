...
WebUI.setText(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/input__connection-name'), 'Bria Connection Katalon Test')
...
'ss'
WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/li_Apikey'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/td_Bria Connection Katalon Test'), 
    0)
