...
WebUI.setText(findTestObject('Page_OneTeg  Simplified Integration/input__connection-name'), 'Dropbox Connection Katalon Test')
...
WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/td_Dropbox Connection Katalon Test'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/td_Dropbox Connection Katalon Test'), 
    0)
