...
WebUI.click(findTestObject('Page_OneTeg  Simplified Integration/li_Connections'))

WebUI.setText(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/input_Active_search-input'), 
    '4Allportal Hospital Katalon Test')
...
WebUI.click(findTestObject('Page_OneTeg  Simplified Integration/span_OK'))

WebUI.setText(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/input_Active_search-input'), 
    '4Allportal Hospital Katalon Test')

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/button_Authentication_refresh-button'))
