...
WebUI.navigateToUrl('https://app.qa.oneteg.com/en/connections')
...
WebUI.setText(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/input_Active_search-input'), 
    'Aws-oneteg-test-assets connection Katalon Test')

WebUI.verifyElementPresent(findTestObject('Page_OneTeg  Simplified Integration/td_Aws-oneteg-test-assets connection Katalon Test'), 
    0)
