...
WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/div_3-4Allportal Hospital Basic Flow  v9'))

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/h6_Apps Get all respository apps (GET)'))
