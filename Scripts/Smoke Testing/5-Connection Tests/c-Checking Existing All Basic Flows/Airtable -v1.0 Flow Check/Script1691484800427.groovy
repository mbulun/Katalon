...
WebUI.setText(findTestObject('Page_OneTeg  Simplified Integration/input_Active_search-input'), 'Airtable -v1.0 basic flow')

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/a_Airtable -v1.0 basic flow'))

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/div_List Records'))

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/button_Search Assets_flow-simulate'))

WebUI.delay(3)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/p_115141.775 main INFO  i.c.c.c.g.i.routes._fe3f28'), 
    0)
