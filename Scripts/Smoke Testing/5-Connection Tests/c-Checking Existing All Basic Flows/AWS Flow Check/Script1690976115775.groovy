...
WebUI.setText(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/input_Active_search-input'), 'AWS Basic Flow')

WebUI.click(findTestObject('Page_OneTeg  Simplified Integration/a_AWS Basic Flow'))
