...
WebUI.setText(findTestObject('Page_OneTeg  Simplified Integration/input_Active_search-input'), 'Onedrive basic flow')

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/a_Onedrive basic flow'))

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/div_Drive Get my files (GET)'))

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/button_Search Assets_flow-simulate'))

WebUI.delay(3)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/p_111457.845 main INFO  i.c.c.c.g.i.routes._aa5ce9'), 
    0)
