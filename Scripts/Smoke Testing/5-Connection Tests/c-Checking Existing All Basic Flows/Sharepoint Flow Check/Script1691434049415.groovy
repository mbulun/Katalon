...
WebUI.setText(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/input_Active_search-input'), 'Sharepoint basic')

WebUI.click(findTestObject('Page_OneTeg  Simplified Integration/a_Sharepoint basic flow'))

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/div_Misc Get Site ID (GET)'))

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/button_Search Assets_flow-simulate'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/p_214816.192 main INFO  i.c.c.c.g.i.routes._160794'), 
    0)
