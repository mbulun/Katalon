...
WebUI.setText(findTestObject('Page_OneTeg  Simplified Integration/input_Active_search-input'), 'Inriver basic flow')

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/a_Inriver basic flow'))

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/div_Query Search for entity ids (POST)'))

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/button_Search Assets_flow-simulate'))

WebUI.delay(3)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/p_112751.808 main INFO  i.c.c.c.g.i.routes._de9a31'), 
    0)
