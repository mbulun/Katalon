...
WebUI.setText(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/input_Active_search-input'), 'Elvis basic flow')

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/a_elvis basic flow'))

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/div_Search Assets'))

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/button_Search Assets_flow-simulate'))

WebUI.delay(3)

WebUI.verifyElementPresent(findTestObject('Page_OneTeg  Simplified Integration/p_143201.986 main INFO  i.c.c.c.g.i.routes._f68499'), 
    0)
