...
WebUI.setText(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/input_Active_search-input'), '4Allportal Hospital Basic Flow')

WebUI.click(findTestObject('Page_OneTeg  Simplified Integration/a_4Allportal Hospital Basic Flow'))
