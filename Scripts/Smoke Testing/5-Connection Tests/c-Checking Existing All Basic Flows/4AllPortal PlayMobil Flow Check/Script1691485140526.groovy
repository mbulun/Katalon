...
WebUI.setText(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/input_Active_search-input'), '4AllPortal PlayMobil basic flow')

WebUI.click(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/a_4AllPortal PlayMobil basic flow'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OneTeg  Simplified Integration/p_115816.374 main INFO  i.c.c.c.g.i.routes._de63cd'), 
    0)
